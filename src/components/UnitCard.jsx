const UnitCard = ({ item }) => {
    return (
        <div>
            <div className=" bg-white px-3 md:px-2 py-2 rounded-md">
                <div className="relative w-[300px]">
                    <img className="h-[400px] rounded-lg shadow-md object-cover w-[300px]" src={item?.img} alt="" />
                    <div className="btn-card w-fit rounded-full absolute p-1 top-2 right-2 h-fit shadow-md">
                        <svg
                            width="24px"
                            height="24px"
                    ...
                    <div className="absolute bottom-3 rounded-md right-4 btn-card w-fit flex flex-row text-center font-medium px-2 py-1">
                        ...
                        <span className="uppercase text-[14px] text-center pt-1">Add to cart</span>
                    </div>
                </div>
                <div className="mt-5">
                    <h3 className="text-[#BA8249] font-extrabold font-montserrat uppercase">{item.title}</h3>
                    <p className=" font-[300] font-helvetica text-sm">{item?.author} </p>
                    <p className="font-helvetica font-bold text-base">₹{item?.price}</p>
                </div>
            </div>
        </div>
    );
